...
export declare class ContentKeyPolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ContentKeyPolicyState, opts?: pulumi.CustomResourceOptions): ContentKeyPolicy;
    /**
     ...
     */
    readonly policyOptions: pulumi.Output<outputs.media.ContentKeyPolicyPolicyOption[]>;
    /**
