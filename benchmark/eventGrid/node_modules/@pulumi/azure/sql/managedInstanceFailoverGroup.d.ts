...
export declare class ManagedInstanceFailoverGroup extends pulumi.CustomResource {
     ...
     */
    readonly partnerRegions: pulumi.Output<outputs.sql.ManagedInstanceFailoverGroupPartnerRegion[]>;
    /**
     * A `readWriteEndpointFailoverPolicy` block as defined below.
     */
    readonly readWriteEndpointFailoverPolicy: pulumi.Output<outputs.sql.ManagedInstanceFailoverGroupReadWriteEndpointFailoverPolicy>;
    /**
