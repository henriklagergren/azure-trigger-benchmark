 ...
 * ```
 */
export declare class SqlPoolSecurityAlertPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlPoolSecurityAlertPolicyState, opts?: pulumi.CustomResourceOptions): SqlPoolSecurityAlertPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is SqlPoolSecurityAlertPolicy;
    /**
