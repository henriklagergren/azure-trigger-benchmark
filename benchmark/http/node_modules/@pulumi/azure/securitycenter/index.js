...
__exportStar(require("./serverVulnerabilityAssessmentVirtualMachine"), exports);
...
const serverVulnerabilityAssessmentVirtualMachine_1 = require("./serverVulnerabilityAssessmentVirtualMachine");
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:securitycenter/serverVulnerabilityAssessmentVirtualMachine:ServerVulnerabilityAssessmentVirtualMachine":
                return new serverVulnerabilityAssessmentVirtualMachine_1.ServerVulnerabilityAssessmentVirtualMachine(name, undefined, { urn });
