 ...
 * ```
 */
export declare class TimeSeriesInsightsStandardEnvironment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TimeSeriesInsightsStandardEnvironmentState, opts?: pulumi.CustomResourceOptions): TimeSeriesInsightsStandardEnvironment;
    /**
     ...
     */
    static isInstance(obj: any): obj is TimeSeriesInsightsStandardEnvironment;
    /**
