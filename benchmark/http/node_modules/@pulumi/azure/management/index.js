...
__exportStar(require("./groupPolicyRemediation"), exports);
...
const groupPolicyRemediation_1 = require("./groupPolicyRemediation");
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:management/groupPolicyRemediation:GroupPolicyRemediation":
                return new groupPolicyRemediation_1.GroupPolicyRemediation(name, undefined, { urn });
