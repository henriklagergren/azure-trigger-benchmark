 ...
 * ```
 */
export declare class DiskPoolIscsiTarget extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DiskPoolIscsiTargetState, opts?: pulumi.CustomResourceOptions): DiskPoolIscsiTarget;
    /**
     * Returns true if the given object is an instance of DiskPoolIscsiTarget.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DiskPoolIscsiTarget;
    /**
     ...
     */
    readonly disksPoolId: pulumi.Output<string>;
    /**
     ...
     */
    readonly targetIqn: pulumi.Output<string | undefined>;
    /**
