...
__exportStar(require("./registryAgentPool"), exports);
...
const registryAgentPool_1 = require("./registryAgentPool");
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:containerservice/registryAgentPool:RegistryAgentPool":
                return new registryAgentPool_1.RegistryAgentPool(name, undefined, { urn });
