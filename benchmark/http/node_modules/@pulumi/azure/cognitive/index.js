...
__exportStar(require("./accountCustomerManagedKey"), exports);
__exportStar(require("./getAccount"), exports);
// Import resources to register:
const account_1 = require("./account");
const accountCustomerManagedKey_1 = require("./accountCustomerManagedKey");
const _module = {
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:cognitive/accountCustomerManagedKey:AccountCustomerManagedKey":
                return new accountCustomerManagedKey_1.AccountCustomerManagedKey(name, undefined, { urn });
            default:
