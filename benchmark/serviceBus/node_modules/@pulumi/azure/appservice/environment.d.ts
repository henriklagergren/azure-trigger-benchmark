...
export declare class Environment extends pulumi.CustomResource {
     ...
     */
    readonly allowedUserIpCidrs: pulumi.Output<string[]>;
    /**
     * Zero or more `clusterSetting` blocks as defined below.
     */
    readonly clusterSettings: pulumi.Output<outputs.appservice.EnvironmentClusterSetting[]>;
    /**
     ...
     */
    readonly pricingTier: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly serviceIpAddress: pulumi.Output<string>;
    /**
     ...
     */
    readonly userWhitelistedIpRanges: pulumi.Output<string[]>;
    /**
