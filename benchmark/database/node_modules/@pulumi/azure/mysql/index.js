...
__exportStar(require("./flexibleDatabase"), exports);
...
const flexibleDatabase_1 = require("./flexibleDatabase");
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:mysql/flexibleDatabase:FlexibleDatabase":
                return new flexibleDatabase_1.FlexibleDatabase(name, undefined, { urn });
