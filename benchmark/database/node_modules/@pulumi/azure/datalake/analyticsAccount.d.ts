 ...
 * ```
 */
export declare class AnalyticsAccount extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AnalyticsAccountState, opts?: pulumi.CustomResourceOptions): AnalyticsAccount;
    /**
     * Returns true if the given object is an instance of AnalyticsAccount.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AnalyticsAccount;
    /**
     * Specifies the data lake store to use by default. Changing this forces a new resource to be created.
     */
    readonly defaultStoreAccountName: pulumi.Output<string>;
    /**
