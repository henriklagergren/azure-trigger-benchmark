 ...
 * ```
 */
class StormCluster extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new StormCluster(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
StormCluster.__pulumiType = 'azure:hdinsight/stormCluster:StormCluster';
//# sourceMappingURL=stormCluster.js.map