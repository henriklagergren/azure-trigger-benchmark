 ...
 * ```
 */
export declare class ConfigurationPolicyAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConfigurationPolicyAssignmentState, opts?: pulumi.CustomResourceOptions): ConfigurationPolicyAssignment;
    /**
     ...
     */
    static isInstance(obj: any): obj is ConfigurationPolicyAssignment;
    /**
     * A `configuration` block as defined below.
     */
    readonly configuration: pulumi.Output<outputs.compute.ConfigurationPolicyAssignmentConfiguration>;
    /**
