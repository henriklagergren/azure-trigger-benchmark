...
export declare class EventSubscription extends pulumi.CustomResource {
     ...
     */
    readonly eventhubEndpoint: pulumi.Output<outputs.eventhub.EventSubscriptionEventhubEndpoint>;
    /**
     ...
     */
    readonly hybridConnectionEndpoint: pulumi.Output<outputs.eventhub.EventSubscriptionHybridConnectionEndpoint>;
    /**
