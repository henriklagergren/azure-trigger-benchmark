 ...
 * ```
 */
export declare class DatasetDataLakeGen1 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatasetDataLakeGen1State, opts?: pulumi.CustomResourceOptions): DatasetDataLakeGen1;
    /**
     * Returns true if the given object is an instance of DatasetDataLakeGen1.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatasetDataLakeGen1;
    /**
     * The resource ID of the Data Lake Store to be shared with the receiver.
     */
    readonly dataLakeStoreId: pulumi.Output<string>;
    /**
