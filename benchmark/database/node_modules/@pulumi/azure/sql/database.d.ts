...
export declare class Database extends pulumi.CustomResource {
     ...
     */
    readonly elasticPoolName: pulumi.Output<string>;
     ...
     */
    readonly extendedAuditingPolicy: pulumi.Output<outputs.sql.DatabaseExtendedAuditingPolicy>;
    /**
     * A Database Import block as documented below. `createMode` must be set to `Default`.
     */
    readonly import: pulumi.Output<outputs.sql.DatabaseImport | undefined>;
    /**
     ...
     */
    readonly sourceDatabaseDeletionDate: pulumi.Output<string>;
    /**
     * The URI of the source database if `createMode` value is not `Default`.
     */
    readonly sourceDatabaseId: pulumi.Output<string>;
    /**
     ...
     */
    readonly threatDetectionPolicy: pulumi.Output<outputs.sql.DatabaseThreatDetectionPolicy>;
    /**
