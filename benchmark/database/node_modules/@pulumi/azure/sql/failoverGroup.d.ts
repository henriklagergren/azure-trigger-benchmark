...
export declare class FailoverGroup extends pulumi.CustomResource {
     ...
     */
    readonly partnerServers: pulumi.Output<outputs.sql.FailoverGroupPartnerServer[]>;
    /**
     * A read/write policy as documented below
     */
    readonly readWriteEndpointFailoverPolicy: pulumi.Output<outputs.sql.FailoverGroupReadWriteEndpointFailoverPolicy>;
    /**
     * a read-only policy as documented below
     */
    readonly readonlyEndpointFailoverPolicy: pulumi.Output<outputs.sql.FailoverGroupReadonlyEndpointFailoverPolicy>;
    /**
