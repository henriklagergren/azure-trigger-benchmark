 ...
 * ```
 */
export declare class MeshLocalNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MeshLocalNetworkState, opts?: pulumi.CustomResourceOptions): MeshLocalNetwork;
    /**
     * Returns true if the given object is an instance of MeshLocalNetwork.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MeshLocalNetwork;
    /**
     ...
     */
    readonly networkAddressPrefix: pulumi.Output<string>;
    /**
