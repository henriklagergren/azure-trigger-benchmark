...
export declare class PacketCapture extends pulumi.CustomResource {
     ...
     */
    readonly filters: pulumi.Output<outputs.network.PacketCaptureFilter[] | undefined>;
    /**
     ...
     */
    readonly storageLocation: pulumi.Output<outputs.network.PacketCaptureStorageLocation>;
    /**
