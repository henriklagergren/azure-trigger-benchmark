...
export declare class VirtualHubConnection extends pulumi.CustomResource {
     ...
     */
    readonly hubToVitualNetworkTrafficAllowed: pulumi.Output<boolean | undefined>;
    /**
     ...
     * @deprecated Due to a breaking behavioural change in the Azure API this property is no longer functional and will be removed in version 3.0 of the provider
     */
    readonly vitualNetworkToHubGatewaysTrafficAllowed: pulumi.Output<boolean | undefined>;
    /**
